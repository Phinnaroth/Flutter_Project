...
class _CourseScoreFormState extends State<CourseScoreForm> {
  ...
  void initState() {
    ...
    _scoreController.text = '50'; // Default score
  }
  ...
  void _saveItem() {
    ...
    double enteredScore = double.tryParse(_scoreController.text) ?? 50;

    Navigator.of(context).pop(
      CourseScore(studentName: enteredName, studenScore: enteredScore),
    );
  }
